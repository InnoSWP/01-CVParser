...
class MainPage extends StatelessWidget {
  ...
  Widget buildLeft(BuildContext context) {
    return Container(
      child: Column(
        children: [
          Row(children: [logo(context), buildContact(context)]),
          Expanded(
            child: Container(
              ...
              Column(children: const [
                Text('Konstantin Fedorov',
                    ...
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w400,
                        color: colorTextSmoothBlack)),
                Text('k.fedorov@innopolis.university   +79221994815',
                    textAlign: TextAlign.start,
                    style: TextStyle(
                        height: 0.2,
                        fontSize: 20.2,
            ...
            child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      fixedSize:
                          MaterialStateProperty.all<Size>(const Size(250, 35)),
                    ),
                    onPressed: () {},
